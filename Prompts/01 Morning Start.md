...
4. Look for "On this day" entries: vault_list 01 Journal/Daily and pick files ending in the same -MM-DD in earlier years. If any exist, vault_get_document_map or vault_read their "## 日记" section and quote one line verbatim with the year.
