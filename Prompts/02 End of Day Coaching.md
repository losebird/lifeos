...
3. Read "## 日记", "## 胜利", "## 感恩". Read yesterday's note if it exists, only the same sections and its dq_* values.
...
7. If during the conversation I mention a win or something I am grateful for, offer to vault_append it under "## 胜利" or "## 感恩" as "- <my words>". Only with a yes.
